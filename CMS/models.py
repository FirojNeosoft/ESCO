...
class Survey(models.Model):
    ...
    annual_electric_usage = models.DecimalField('Annual Electric Usage', max_digits=10, decimal_places=6, blank=True, null=True)
    jan_electric_usage = models.DecimalField('Base Usage Jan - Electric', max_digits=10, decimal_places=6, blank=True, null=True)
    feb_electric_usage = models.DecimalField('Base Usage Feb - Electric', max_digits=10, decimal_places=6, blank=True, null=True)
    mar_electric_usage = models.DecimalField('Base Usage Mar - Electric', max_digits=10, decimal_places=6, blank=True, null=True)
    apr_electric_usage = models.DecimalField('Base Usage Apr - Electric', max_digits=10, decimal_places=6, blank=True, null=True)
    may_electric_usage = models.DecimalField('Base Usage May - Electric', max_digits=10, decimal_places=6, blank=True, null=True)
    jun_electric_usage = models.DecimalField('Base Usage Jun - Electric', max_digits=10, decimal_places=6, blank=True, null=True)
    jul_electric_usage = models.DecimalField('Base Usage Jul - Electric', max_digits=10, decimal_places=6, blank=True, null=True)
    aug_electric_usage = models.DecimalField('Base Usage Aug - Electric', max_digits=10, decimal_places=6, blank=True, null=True)
    sep_electric_usage = models.DecimalField('Base Usage Sep - Electric', max_digits=10, decimal_places=6, blank=True, null=True)
    oct_electric_usage = models.DecimalField('Base Usage Oct - Electric', max_digits=10, decimal_places=6, blank=True, null=True)
    nov_electric_usage = models.DecimalField('Base Usage Nov - Electric', max_digits=10, decimal_places=6, blank=True, null=True)
    dec_electric_usage = models.DecimalField('Base Usage Dec - Electric', max_digits=10, decimal_places=6, blank=True, null=True)
    annual_gas_usage = models.DecimalField('Annual Gas Usage', max_digits=10, decimal_places=6, blank=True, null=True)
    jan_gas_usage = models.DecimalField('Base Usage Jan - Gas', max_digits=10, decimal_places=6, blank=True, null=True)
    feb_gas_usage = models.DecimalField('Base Usage Feb - Gas', max_digits=10, decimal_places=6, blank=True, null=True)
    mar_gas_usage = models.DecimalField('Base Usage Mar - Gas', max_digits=10, decimal_places=6, blank=True, null=True)
    apr_gas_usage = models.DecimalField('Base Usage Apr - Gas', max_digits=10, decimal_places=6, blank=True, null=True)
    may_gas_usage = models.DecimalField('Base Usage May - Gas', max_digits=10, decimal_places=6, blank=True, null=True)
    jun_gas_usage = models.DecimalField('Base Usage Jun - Gas', max_digits=10, decimal_places=6, blank=True, null=True)
    jul_gas_usage = models.DecimalField('Base Usage Jul - Gas', max_digits=10, decimal_places=6, blank=True, null=True)
    aug_gas_usage = models.DecimalField('Base Usage Aug - Gas', max_digits=10, decimal_places=6, blank=True, null=True)
    sep_gas_usage = models.DecimalField('Base Usage Sep - Gas', max_digits=10, decimal_places=6, blank=True, null=True)
    oct_gas_usage = models.DecimalField('Base Usage Oct - Gas', max_digits=10, decimal_places=6, blank=True, null=True)
    nov_gas_usage = models.DecimalField('Base Usage Nov - Gas', max_digits=10, decimal_places=6, blank=True, null=True)
    dec_gas_usage = models.DecimalField('Base Usage Dec - Gas', max_digits=10, decimal_places=6, blank=True, null=True)
    created_at = models.DateTimeField(auto_now_add=True)
